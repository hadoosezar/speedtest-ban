...
function backup_db(){
    ...
    cp /etc/x-ui-english/x-ui-english.db /root/speedtest_ban_backup/
    echo -e "${RED} Backup has been created in '/root/speedtest_ban_backup/x-ui-english.db'${NC}"
